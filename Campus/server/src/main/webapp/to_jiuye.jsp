    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <%
                ...
                //按shifoujiuye的分组统计人数
                List<HashMap> list = Query.make("xuesheng").where(where).field("count(*) count,shifoujiuye")
                        .group("shifoujiuye")
                        .order("count(*) desc").select();
                //查询总人数
                long zong = Query.make("xuesheng")
            ...
            <table class="table">
                ...
                <%}%>
                <tr>
                    <td align="center" colspan="2"> 总次数 ：<%=zong%>
                    </td>
                </tr>
                <tr>
                    <td id="container" style="max-width:750px;height:50%"></td>
                    <script>
