...
//                }
                    ...
                    return arr.push({
                        _src: node.getAttribute('_src'),
                        src: node.getAttribute('_src')
                    });
                });
                return arr;
            },
            ...
            callback: function (editor, $w, url, state) {
                ...
                if (state == "SUCCESS") {
                    //显示图片计数+1
                    Upload.showCount++;
                    var $img = $("<img src='" + editor.options.imagePath + url + "' _src='"+editor.options.imagePath + url+"' class='edui-image-pic' />"),
