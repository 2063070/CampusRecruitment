<template>
    <div class="ceshichengji-add" v-loading="loading">
        <el-card class="box-card">
            <div slot="header" class="clearfix">
                                <span class="title"> 添加测试成绩</span>
                            </div>
            ...
            <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                                ...
                                <el-form-item label="考试编号" prop="kaoshibianhao" :rules="[{required:true, message:'请填写考试编号'}]">
                                            <el-input placeholder="输入考试编号" style="width:250px;" v-model="form.kaoshibianhao" />                                    </el-form-item>

                                <el-form-item label="考试时长" prop="kaoshishizhang">
                                            <el-input placeholder="输入考试时长" style="width:250px;" v-model="form.kaoshishizhang" />                                    </el-form-item>
                                ...
                                <el-form-item label="考试人" prop="kaoshiren">
        ...
        methods: {
            submit(){
                this.$refs.formModel.validate().then(res=>{
                    ...
                    this.$post(api.ceshichengji.insert , form).then(res=>{
                        this.loading = false;
            ...
            loadInfo(){
                ...
                // 获取模块得数据
                this.loading = true;
                this.$post(api.ceshichengji.create , {
                    ...
                    if(res.code == api.code.OK){
                        ...
                        form.ceshishijuanid = readMap.id;
                                            }else{
                        this.$message.error(res.msg);
                        this.$router.go(-1);
                    }
