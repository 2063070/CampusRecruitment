<template>
    <div class="ceshijieguo-add" v-loading="loading">
        <el-card class="box-card">
            <div slot="header" class="clearfix">
                                <span class="title"> 添加测试结果</span>
                            </div>
        ...
        methods: {
            submit(){
                this.$refs.formModel.validate().then(res=>{
                    ...
                    this.$post(api.ceshijieguo.insert , form).then(res=>{
                        this.loading = false;
            ...
            loadInfo(){
                ...
                // 获取模块得数据
                this.loading = true;
                this.$post(api.ceshijieguo.create , {
