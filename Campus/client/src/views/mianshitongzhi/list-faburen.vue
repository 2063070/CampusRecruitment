        ...
        <el-card class="box-card">
            ...
            <div class="form-search">
                <el-form @submit.prevent.stop :inline="true" size="mini">
                    ...
                    <el-form-item label="面试时间">
                        ...
                        <el-date-picker
                                v-model="search.mianshishijian_start"
                                type="datetime"
                        ...
                        -
                        <el-date-picker
                                v-model="search.mianshishijian_end"
                                type="datetime"
                                value-format="yyyy-MM-dd HH:mm:ss"
                                placeholder="选择日期">
                        </el-date-picker>
            ...
            >
                ...
                <el-table-column label="操作">
                    <template slot-scope="{row}">
                        <el-button-group>
                            <template v-if="row.mianshijieguoCount==0">
                                <el-button @click="$goto('/admin/mianshijieguoadd?id='+row.id)" type="success"
                            ...
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit"
                                           @click="$goto({path:'/admin/mianshitongzhiupdt',query:{id:row.id } })"
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.mianshitongzhi.listfaburen, filter).then(res => {
                    this.loading = false;
            ...
            deleteItem(row) {
                this.$confirm('确定删除数据？', '提示', { // 弹出 确认框提示是否要删除
                    ...
                    this.$post(api.mianshitongzhi.delete, {// 提交后台
                        id: row.id
                    }).then(res => {
                        this.loading = false;
                        if (res.code != api.code.OK) {
