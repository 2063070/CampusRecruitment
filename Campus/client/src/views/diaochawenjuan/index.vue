<template>
    <div v-loading="loading">
        <div>
            <e-container>
                <div  style="margin:20px 0 0 0;background-color:#FFFFFF;box-shadow:0px 0px 3px 3px #EDEDED">
                    <e-module-widget-title title="调查问卷列表">
                        ...
                        <div class="hotnews class1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="search-radio">
                                                    ...
                                                    <a href="javascript:;" @click="selectRadio('leixing','')"
                                                       :class="{active:!search.leixing}">全部</a>

                                                    <a href="javascript:;"
                                                       v-for="r in mapleixing1"
                                                       @click="selectRadio('leixing',r.id)" :class="{active:search.leixing == r.id}" v-text="r.leixing">
                            ...
                            <ul class="a">
                                <li v-for="(r,i) in list">
                                    <router-link :to="{path:'/diaochawenjuandetail',query:{id:r.id}}" class="clearfix">
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.diaochawenjuan.weblist, filter).then(res => {
                    this.loading = false;
