<template>
    <div class="diaochawenjuan-detail" v-loading="loading">
        <div>
            <e-container>
            ...
            <span class="show_t" v-html="map.mingcheng">
                            ...
                            <span class="fa_time">
                                    答题时长:{{ map.datishichang }} &nbsp;&nbsp;
                                    发布人:{{ map.faburen }} &nbsp;&nbsp;
                                    类型: <e-select-view module="leixing" :value="map.leixing" select="id"
    ...
    export default {
        ...
        methods: {
            ...
            loadDetail() {
                if (this.loading) return;
                this.loading = true;
                this.$get(api.diaochawenjuan.webdetail, {
                    id: this.id
                }).then(res => {
                    this.loading = false;
                    if (res.code == api.code.OK) {
