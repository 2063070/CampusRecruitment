            ...
            <div class="form-database-form">
                ...
                <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                    <el-form-item label="账号" prop="zhanghao" required
                                  :rules="[{required:true, message:'请填写账号'}, {checktype:'update', module:'gaoxiaoguanliyuan', col:'zhanghao', id:'{{   form.id   }}', trigger:'blur'}]">
                        <el-input placeholder="输入账号" style="width:250px;" v-model="form.zhanghao"/>
                    </el-form-item>

                    <el-form-item label="高校名称" prop="gaoxiaomingcheng">
                        <el-input placeholder="输入高校名称" style="width:450px;" v-model="form.gaoxiaomingcheng"/>
                    </el-form-item>
                    ...
                    <el-form-item label="高校地址" prop="gaoxiaodizhi">
                        <el-input placeholder="输入高校地址" style="width:450px;" v-model="form.gaoxiaodizhi"/>
                    </el-form-item>
