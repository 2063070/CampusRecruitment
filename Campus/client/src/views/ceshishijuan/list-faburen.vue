    ...
    <div class="v-list" v-loading="loading" element-loading-text="加载中">
        ...
        <el-card class="box-card">
            ...
            <div class="form-search">
                <el-form @submit.prevent.stop :inline="true" size="mini">
                    ...
                    <el-form-item label="考试时长">
                        ...
                        <el-input type="text" style="width:80px;" v-model="search.kaoshishizhang_start"></el-input>
                        -
                        <el-input type="text" style="width:80px;" v-model="search.kaoshishizhang_end"></el-input>
            ...
            >
                ...
                <el-table-column label="考试时长" width="80">
                    <template slot-scope="{row}">
                        {{ row.kaoshishizhang }}
                    </template>
                </el-table-column>
                ...
                <el-table-column label="操作">
                    <template slot-scope="{row}">
                        <el-button-group>
                            <el-button @click="$goto('/admin/ceshishitiadd?id='+row.id)" type="success"
                                       icon="el-icon-plus" size="mini">
                                测试试题添加
                            </el-button>
                            <el-tooltip content="详情" placement="top">
                                <el-button @click="$goto({path:'/admin/ceshishijuandetail',query:{id:row.id } })"
                                           icon="el-icon-info" type="info" size="mini"></el-button>
                            </el-tooltip>
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit"
                                           @click="$goto({path:'/admin/ceshishijuanupdt',query:{id:row.id } })"
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.ceshishijuan.listfaburen, filter).then(res => {
                    this.loading = false;
            ...
            deleteItem(row) {
                this.$confirm('确定删除数据？', '提示', { // 弹出 确认框提示是否要删除
                    ...
                    this.$post(api.ceshishijuan.delete, {// 提交后台
                        id: row.id
                    }).then(res => {
                        this.loading = false;
                        if (res.code != api.code.OK) {
