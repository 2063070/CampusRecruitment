    ...
    <div class="ceshishijuan-add" v-loading="loading">
        <el-card class="box-card">
            <div slot="header" class="clearfix updt">
                                    <el-page-header @back="$router.go(-1)" content="编辑测试试卷">
                    </el-page-header>
                            </div>
            ...
            <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                                ...
                                <el-form-item label="考试时长" prop="kaoshishizhang" :rules="[{validator:rule.checkNumber, message:'输入一个有效数字'}]">
        ...
        methods: {
            submit(){
                this.$refs.formModel.validate().then(res=>{
                    ...
                    this.$post(api.ceshishijuan.update , form).then(res=>{
                        this.loading = false;
            ...
            loadInfo(){
                ...
                this.loading = true;
                var form = this.form;
                this.$post(api.ceshishijuan.edit , {
                    id:this.id
                }).then(res=>{
                    this.loading = false;
                    if(res.code == api.code.OK){
