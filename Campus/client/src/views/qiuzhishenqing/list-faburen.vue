        ...
        <el-card class="box-card">
            ...
            >
                ...
                <el-table-column label="简历类型" width="80">
                    <template slot-scope="{row}">
                        <e-select-view module="jianlileixing" :value="row.jianlileixing" select="id"
                ...
                <el-table-column label="简历文件">
                    <template slot-scope="{row}">
                        <e-file-list v-model="row.jianliwenjian"></e-file-list>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="操作">
                    <template slot-scope="{row}">
                        <el-button-group>
                            <el-button @click="$goto('/admin/shenqingshenheadd?id='+row.id)" type="success"
                                       v-if="row.zhuangtai=='待审核'||row.zhuangtai=='驳回'"  icon="el-icon-plus" size="mini">
                                申请审核添加
                            </el-button>
                            <el-button @click="$goto('/admin/mianshitongzhiadd?id='+row.id)" type="success"
                                       v-if="row.zhuangtai=='通过'"   icon="el-icon-plus" size="mini">
                                面试通知添加
                            </el-button>
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit"
                                           @click="$goto({path:'/admin/qiuzhishenqingupdt',query:{id:row.id } })"
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.qiuzhishenqing.listfaburen, filter).then(res => {
                    this.loading = false;
