            ...
            <div class="form-database-form">
                ...
                <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                    ...
                    <el-form-item label="答案" prop="daan">
                        <e-paper v-model="form.daan" :type="form.leixing" danxuanti="单选题" duoxuanti="多选题" panduanti=""></e-paper>
                    </el-form-item>
        ...
        methods: {
            submit() {
                this.$refs.formModel.validate().then(res => {
                    ...
                    this.$post(api.ceshishiti.insert, form).then(res => {
                        this.loading = false;
            ...
            loadInfo() {
                ...
                // 获取模块得数据
                this.loading = true;
                this.$post(api.ceshishiti.create, {
